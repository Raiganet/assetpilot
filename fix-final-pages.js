...
console.log('🚀 Creating missing Warehouses and Assets pages...\n');
...
console.log('\n✅ Warehouses and Assets pages created successfully!');
console.log('Next steps:');
console.log('1. git add .');
console.log('2. git commit -m "feat: add warehouses and assets pages"');
